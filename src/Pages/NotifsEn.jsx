...
export const NotifsEn = () => {
    ...
    const fetchNotifications = async (userId) => {
        try {
            const response = await fetch(`https://localhost/backend/notification_crud/get_notifications.php?user_id=${userId}`);
    ...
    const markAsRead = async (notificationId) => {
        try {
            const response = await fetch('https://localhost/backend/notification_crud/mark_lu.php', {
                method: 'POST',
    ...
    const deleteNotification = async (notificationId) => {
        try {
            const response = await fetch('https://localhost/backend/notification_crud/delete_notification.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ notification_id: notificationId })
            });
