...
function OffresForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/offre_crud/add_offre.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
function OffresTable(){
    ...
    const fetchOffres = async () => {
        try {
            ...
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/offre_crud/get_offres.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cette offre ? Toutes les données associées seront également supprimées.")) {
            try {
                ...
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/offre_crud/delete_offre.php', {
                    method: 'DELETE',
                    headers: { 
    ...
    const handleSave = async (id) => {
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/offre_crud/update_offre.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idoffre: id, 
...
function CompetencesTableOff() {
    ...
    useEffect(() => {
        const fetchCompetences = async () => {
            try {
                const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
                const response = await fetch(`http://jobconnectbackend.ct.ws/backend/competence_crud/get_competencesoff.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cette compétence ?")) {
            try {
                const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/competence_crud/delete_competenceoff.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ 
                        idcompetence: id,
    ...
    const handleSave = async (id) => {
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/competence_crud/update_competenceoff.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idcompetence: id,
...
function LanguesTableOff() {
    ...
    useEffect(() => {
        const fetchLangues = async () => {
            try {
                ...
                const response = await fetch(`http://jobconnectbackend.ct.ws/backend/langue_crud/get_languesoff.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cette langue ?")) {
            try {
                const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/langue_crud/delete_langueoff.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ 
                        idlangue: id,
    ...
    const handleSave = async (id) => {
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/langue_crud/update_langueoff.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idlangue: id,
...
function QualitesTableOff() {
    ...
    useEffect(() => {
        const fetchQualites = async () => {
            try {
                const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
                const response = await fetch(`http://jobconnectbackend.ct.ws/backend/qualite_crud/get_qualitesoff.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cette qualité professionnelle ?")) {
            try {
                const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/qualite_crud/delete_qualiteoff.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ 
                        idqualite: id,
    ...
    const handleSave = async (id) => {
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/qualite_crud/update_qualiteoff.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idqualite: id,
...
function MissionsFormOff() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/mission_crud/add_mission.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function MissionsTableOff() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const offresResponse = await fetch(`http://jobconnectbackend.ct.ws/backend/offre_crud/get_offres.php?iduser=${user.iduser}`);
                if (!offresResponse.ok) throw new Error('Erreur lors du chargement des offres');
                setOffres(await offresResponse.json());
    
                
                const missionsResponse = await fetch(`http://jobconnectbackend.ct.ws/backend/mission_crud/get_missions.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cette mission ?")) {
            try {
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/mission_crud/delete_mission.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
    ...
    const handleSave = async (id) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/mission_crud/update_mission.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idmission: id,
...
function AvantagesFormOff() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/avantage_crud/add_avantage.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function AvantagesTableOff() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const avantagesResponse = await fetch(`http://jobconnectbackend.ct.ws/backend/avantage_crud/get_avantages.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cet avantage ?")) {
            try {
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/avantage_crud/delete_avantage.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
    ...
    const handleSave = async (id) => {
        setIsSubmitting(true);
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/avantage_crud/update_avantage.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idavantage: id,
...
function DocRequisFormOff() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/documentrequis_crud/add_docrequis.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function DocRequisTableOff() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const docsResponse = await fetch(`http://jobconnectbackend.ct.ws/backend/documentrequis_crud/get_documents.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer ce document requis ?")) {
            try {
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/documentrequis_crud/delete_document.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
    ...
    const handleSave = async (id) => {
        setIsSubmitting(true);
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/documentrequis_crud/update_document.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    iddocumentreq: id,
