...
export const Compte = () => {
    ...
    const handleUpdateUser = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/update_user.php', {
                method: 'POST',
...
function ExperiencesForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/experience_crud/add_experience.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
function ExperiencesTable() {
    ...
    const fetchExperiences = async () => {
        ...
        const response = await fetch(`http://jobconnectbackend.ct.ws/backend/experience_crud/get_experiences.php?iduser=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cette expérience ?")) {
            try {
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/experience_crud/delete_experience.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
    ...
    const handleEditSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/experience_crud/update_experience.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
...
function CompetencesForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/competence_crud/add_competence.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function CompetencesTable() {
    ...
    const fetchCompetences = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/competence_crud/get_competences.php?iduser=${user.iduser}`);
            const data = await response.json();
            setCompetences(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/competence_crud/delete_competence.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idcompetence: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/competence_crud/update_competence.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
...
function FormationsForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/formation_crud/add_formation.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function FormationsTable() {
    ...
    const fetchFormations = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/formation_crud/get_formations.php?iduser=${user.iduser}`);
            const data = await response.json();
            setFormations(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/formation_crud/delete_formation.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idformation: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/formation_crud/update_formation.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...editForm,
...
function QualitesForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/qualite_crud/add_qualite.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function QualitesTable() {
    ...
    const fetchQualites = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/qualite_crud/get_qualites.php?iduser=${user.iduser}`);
            const data = await response.json();
            setQualites(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/qualite_crud/delete_qualite.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idqualite: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/qualite_crud/update_qualite.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...editForm,
...
function ReferencesForm({ onReferenceAdded }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/reference_crud/add_reference.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function ReferencesTable() {
    ...
    const fetchReferences = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/reference_crud/get_references.php?iduser=${user.iduser}`);
            const data = await response.json();
            setReferences(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/reference_crud/delete_reference.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idreference: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/reference_crud/update_reference.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...editForm,
...
function InteretsForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/interet_crud/add_interet.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function InteretsTable() {
    ...
    const fetchInterets = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/interet_crud/get_interets.php?iduser=${user.iduser}`);
            const data = await response.json();
            setInterets(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/interet_crud/delete_interet.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idinteret: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/interet_crud/update_interet.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...editForm,
...
function LanguesForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/langue_crud/add_langue.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function LanguesTable() {
    ...
    const fetchLangues = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/langue_crud/get_langues.php?iduser=${user.iduser}`);
            const data = await response.json();
            setLangues(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/langue_crud/delete_langue.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idlangue: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/langue_crud/update_langue.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...editForm,
...
function ProjetsForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/projet_crud/add_projet.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function ProjetsTable() {
    ...
    const fetchProjets = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/projet_crud/get_projets.php?iduser=${user.iduser}`);
            const data = await response.json();
            setProjets(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/projet_crud/delete_projet.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idprojet: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/projet_crud/update_projet.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...editForm,
...
function DiplomesForm(){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/diplome_crud/add_diplome.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function DiplomesTable() {
    ...
    const fetchDiplomes = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch(`http://jobconnectbackend.ct.ws/backend/diplome_crud/get_diplomes.php?iduser=${user.iduser}`);
            const data = await response.json();
            setDiplomes(data);
        } catch (error) {
            console.error("Erreur:", error);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/diplome_crud/delete_diplome.php', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    iddiplome: id,
    ...
    const handleEditSubmit = async () => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/diplome_crud/update_diplome.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    ...editForm,
...
function CertificationsForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/certification_crud/add_certification.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
...
function CertificationsTable() {
    ...
    useEffect(() => {
        const fetchCertifications = async () => {
            try {
                const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
                const response = await fetch(`http://jobconnectbackend.ct.ws/backend/certification_crud/get_certifications.php?utilisateur_id=${user.iduser}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Êtes-vous sûr de vouloir supprimer cette certification ?")) {
            try {
                const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
                const response = await fetch('http://jobconnectbackend.ct.ws/backend/certification_crud/delete_certification.php', {
                    method: 'DELETE',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ 
                        idcertification: id,
    ...
    const handleSave = async (id) => {
        ...
        try {
            const user = JSON.parse(localStorage.getItem("user") || sessionStorage.getItem("user"));
            const response = await fetch('http://jobconnectbackend.ct.ws/backend/certification_crud/update_certification.php', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ 
                    idcertification: id,
