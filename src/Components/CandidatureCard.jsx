...
export const CandidatureCard = ({ candidature, onStatusChange }) => {
    ...
    const handleStatusUpdate = async (newStatus) => {
        ...
        try {
            ...
            const response = await fetch(`https://185.27.134.109/backend/candidature_crud/update_candidature.php`, {
                method: 'POST',
                headers: {
    ...
    const handleDelete = async () => {
        setIsUpdating(true);
        try {
            const response = await fetch(`https://185.27.134.109/backend/candidature_crud/delete_candidature.php`, {
                method: 'DELETE', 
                headers: {
                    'Content-Type': 'application/json',
                },
